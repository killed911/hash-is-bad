...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 49
    sget-object p1, Lcom/db/chart/view/ChartView$Orientation;->HORIZONTAL:Lcom/db/chart/view/ChartView$Orientation;

    invoke-virtual {p0, p1}, Lcom/db/chart/view/HorizontalStackBarChartView;->setOrientation(Lcom/db/chart/view/ChartView$Orientation;)V
...
.method defineRegions(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget v8, v0, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    iget v3, v0, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    .line 238
    invoke-virtual {v4, v11, v8, v2, v3}, Landroid/graphics/Region;->set(IIII)Z
    ...
    iget v15, v0, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    .line 245
    invoke-virtual {v4, v8, v3, v13, v14}, Landroid/graphics/Region;->set(IIII)Z
    ...
    iget v14, v0, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    .line 252
    invoke-virtual {v3, v4, v8, v2, v14}, Landroid/graphics/Region;->set(IIII)Z
...
.method public onDrawChart(Landroid/graphics/Canvas;Ljava/util/ArrayList;)V
    ...
    .line 78
    iget-object v0, v7, Lcom/db/chart/view/HorizontalStackBarChartView;->style:Lcom/db/chart/view/BaseBarChartView$Style;
    ...
    iget v1, v7, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    .line 78
    invoke-virtual/range {v0 .. v5}, Lcom/db/chart/view/HorizontalStackBarChartView;->drawBarBackground(Landroid/graphics/Canvas;FFFF)V

    .line 93
    :cond_0
    invoke-static {v14, v9}, Lcom/db/chart/view/HorizontalStackBarChartView;->discoverBottomSet(ILjava/util/ArrayList;)I

    move-result v6

    .line 94
    invoke-static {v14, v9}, Lcom/db/chart/view/HorizontalStackBarChartView;->discoverTopSet(ILjava/util/ArrayList;)I
    ...
    .line 110
    :cond_1
    iget-object v1, v7, Lcom/db/chart/view/HorizontalStackBarChartView;->style:Lcom/db/chart/view/BaseBarChartView$Style;
    ...
    .line 111
    invoke-virtual/range {v0 .. v6}, Lcom/db/chart/view/HorizontalStackBarChartView;->applyShadow(Landroid/graphics/Paint;FFFF[I)V
    ...
    iget v2, v7, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    .line 123
    invoke-virtual/range {v0 .. v5}, Lcom/db/chart/view/HorizontalStackBarChartView;->drawBar(Landroid/graphics/Canvas;FFFF)V
    ...
    invoke-direct {v1, v0, v10, v9, v12}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v1, v9, v10, v0, v12}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v0, v1, v10, v13, v6}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v0, v6, v10, v1, v13}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v3, v4, v0, v5, v1}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method public onPreDrawChart(Ljava/util/ArrayList;)V
    ...
    iput p1, p0, Lcom/db/chart/view/HorizontalStackBarChartView;->barWidth:F
    ...
    invoke-virtual {p1, v0}, Lcom/db/chart/model/ChartSet;->getEntry(I)Lcom/db/chart/model/ChartEntry;

    move-result-object p1

    invoke-virtual {p1}, Lcom/db/chart/model/ChartEntry;->getY()F

    move-result p1

    invoke-virtual {p0, v1, v2, p1}, Lcom/db/chart/view/HorizontalStackBarChartView;->calculateBarsWidth(IFF)V
