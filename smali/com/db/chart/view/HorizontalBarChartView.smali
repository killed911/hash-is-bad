...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/db/chart/view/HorizontalBarChartView;->setOrientation(Lcom/db/chart/view/ChartView$Orientation;)V
...
.method defineRegions(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget v5, p0, Lcom/db/chart/view/HorizontalBarChartView;->drawingOffset:F
    ...
    iget v10, p0, Lcom/db/chart/view/HorizontalBarChartView;->barWidth:F
    ...
    .line 145
    invoke-virtual {v7, v8, v9, v6, v10}, Landroid/graphics/Region;->set(IIII)Z
    ...
    .line 148
    invoke-virtual {v7, v6, v8, v9, v10}, Landroid/graphics/Region;->set(IIII)Z
    ...
    .line 155
    iget-object v6, p0, Lcom/db/chart/view/HorizontalBarChartView;->style:Lcom/db/chart/view/BaseBarChartView$Style;
...
.method public onDrawChart(Landroid/graphics/Canvas;Ljava/util/ArrayList;)V
    ...
    iget v1, v7, Lcom/db/chart/view/HorizontalBarChartView;->drawingOffset:F
    ...
    iget-object v1, v7, Lcom/db/chart/view/HorizontalBarChartView;->style:Lcom/db/chart/view/BaseBarChartView$Style;
    ...
    .line 83
    invoke-virtual/range {p0 .. p0}, Lcom/db/chart/view/HorizontalBarChartView;->getZeroPosition()F
    ...
    .line 86
    invoke-virtual/range {v0 .. v6}, Lcom/db/chart/view/HorizontalBarChartView;->applyShadow(Landroid/graphics/Paint;FFFF[I)V

    .line 90
    iget-object v0, v7, Lcom/db/chart/view/HorizontalBarChartView;->style:Lcom/db/chart/view/BaseBarChartView$Style;
    ...
    .line 91
    invoke-virtual/range {p0 .. p0}, Lcom/db/chart/view/HorizontalBarChartView;->getInnerChartLeft()F

    move-result v2

    .line 92
    invoke-virtual/range {p0 .. p0}, Lcom/db/chart/view/HorizontalBarChartView;->getInnerChartRight()F

    move-result v4

    iget v0, v7, Lcom/db/chart/view/HorizontalBarChartView;->barWidth:F
...
.method protected onPreDrawChart(Ljava/util/ArrayList;)V
    ...
    .line 114
    invoke-virtual {p0, v0, v1, v2}, Lcom/db/chart/view/HorizontalBarChartView;->calculateBarsWidth(IFF)V
    ...
    invoke-virtual {p0, p1}, Lcom/db/chart/view/HorizontalBarChartView;->calculatePositionOffset(I)V
